          ...
          <div className="mx-auto max-w-4xl">
            ...
            <Card className="border-2 border-muted/30 bg-background/80 shadow-none">
              <CardContent className="space-y-8 p-8 text-base leading-relaxed">
                <LegalParagraph>
                  Your privacy is important to us. It is Analog Interface's
                ...
                <section>
                  ...
                  <LegalParagraph>
                    ...
                    submit content to us, when you register an account or when
                    you contact us — which may include one or more of the
                    following:
                  </LegalParagraph>
                  <ul className="mb-4 list-disc space-y-2 pl-6">
                    <li>Name</li>
                ...
                <section>
                  ...
                  <ul className="mb-4 list-disc space-y-2 pl-6">
                    ...
                    <li>
                      ...
                      and server providers, error loggers, debt collectors,
                ...
                <section>
                  ...
                  <LegalParagraph>
                    ...
                    processed in Germany, Ireland, Netherlands (the), United
                    States of America (the) or where we or our partners,
                ...
                <section>
                  ...
                  <LegalParagraph>
                    ...
                    with this privacy policy. You do not have to provide
                    personal information to us, however, if you do not, it may
                    affect your use of our website or the products and/or
                    services offered on or through it.
                  </LegalParagraph>
                  <LegalParagraph>
                    <strong>Information from third parties:</strong> If we
                    receive personal information about you from a third party,
                    we will protect it as set out in this privacy policy. If you
                    are a third party providing personal information about
                  ...
                  <LegalParagraph>
                    ...
                    using the details provided in this privacy policy. We will
                  ...
                  <LegalParagraph>
                    ...
                    discriminate against you for exercising any of your rights
                    over your personal information. Unless your personal
                    information is required to provide you with a particular
                    service or offer (for example providing user support), we
                    will not deny you goods or services and/or charge you
                    different prices or rates for goods or services, including
                    through granting discounts or other benefits, or imposing
                    penalties, or provide you with a different level or quality
                  ...
                  <LegalParagraph>
                    ...
                    writing, setting out the outcome of our investigation and
                    the steps we will take to deal with your complaint. You also
                    have the right to contact a regulatory body or data
                ...
                <section>
                  <LegalHeading2>
                    Additional Disclosures for U.S. States Privacy Law
                    Compliance.
                  </LegalHeading2>
                  <LegalParagraph>
                    The following section includes provisions that comply with
                    the privacy laws of these states (California, Colorado,
                    Delaware, Florida, Virginia, and Utah) and is applicable
                    only to the residents of those states. Specific references
                    to a particular state (in a heading or in the text) are only
                    a reference to that state's law and applies only to that
                    state's residents. Non-state specific language applies to
                    all of the states listed above.
                  </LegalParagraph>
                  ...
                  <LegalParagraph>
                    ...
                    levels for the goods or services we provide. Any
                    CCPA-permitted financial incentive we offer will reasonably
                    relate to the value of your personal information, and we
                    will provide written terms that describe clearly the nature
                    of such an offer. Participation in a financial incentive
                    program requires your prior opt-in consent, which you may
                    revoke at any time.
                  </LegalParagraph>
                  <LegalParagraph>
                    Under California Civil Code Section 1798.83, if you live in
                    ...
                    their marketing purposes in the last calendar year, along
                    with their names and addresses. Not all personal information
                    shared in this way is covered by Section 1798.83 of the
                  ...
                  <LegalParagraph>
                    ...
                    practices in the preceding 12 months. In particular, you
                  ...
                  <LegalParagraph>
                    In addition to the rights discussed above, you have the
                    right to request information from us regarding the manner in
                    which we share certain personal information as defined by
                    applicable statute with third parties and affiliates for
                  ...
                  <LegalParagraph>
                    ...
                    must include "Privacy Rights Request" in the first line of
                    the description and include your name, street address, city,
                    state, and ZIP code.
                  </LegalParagraph>
                </section>
                ...
                <section>
                  ...
                  <LegalParagraph>
                    ...
                    provided in our Contact Us section, are a Data Controller
                  ...
                  <LegalParagraph>
                    ...
                    years of age, we will seek your parent or legal guardian's
                  ...
                  <LegalParagraph>
                    ...
                    address for the purpose of receiving marketing emails from
                    us. While you may unsubscribe at any time, we cannot recall
                    any email we have already sent. If you have any further
                    enquiries about how to withdraw your consent, please feel
                  ...
                  <LegalParagraph>
                    ...
                    example, if you contact us with an enquiry, we may require
                  ...
                  <LegalParagraph>
                    ...
                    communicate our services. We consider our legitimate
                    interests to include research and development, understanding
                    our audience, marketing and promoting our services, measures
                    taken to operate our services efficiently, marketing
                  ...
                  <ol className="mb-4 list-decimal space-y-2 pl-6">
                    ...
                    <li>
                      you need us to maintain the personal information solely
                      for the purpose of a legal claim; or
                    </li>
                    <li>
                  ...
                  <LegalParagraph>
                    ...
                    based on our legitimate interests or public interest. If
                    this is done, we must provide compelling legitimate grounds
                    for the processing which overrides your interests, rights,
                    and freedoms, in order to proceed with the processing of
                  ...
                  <LegalParagraph>
                    ...
                    format or other easily readable machine format. You may also
                    have the right to request that we transfer this personal
                  ...
                  <LegalParagraph>
                    ...
                    to delete your personal information, we will let you know
                    how the deletion affects your use of our website or products
                    and services. There may be exceptions to this right for
                    specific legal reasons which, if applicable, we will set out
                    for you in response to your request. If you terminate or
                    delete your account, we will delete your personal
                    information within 30 days of the deletion of your account.
                ...
                <section>
                  ...
                  <LegalParagraph>
                    We may indirectly collect personal information about you
                    from third-parties who have your permission to share it. For
                    example, if you purchase a product or service from a
                    business working with us, and give your permission for us to
                    use your details in order to complete the transaction.
                  </LegalParagraph>
                  <LegalParagraph>
                    We may also collect publicly available information about
                    you, such as from any social media and messaging platforms
                    you may use. The availability of this information will
                    depend on both the privacy policies and your own privacy
                  ...
                  <LegalParagraph>
                    ...
                    stated purposes, or if you instruct us under your Data
                    Subject Rights, we will delete it or make it anonymous by
                    removing all details that identify you ("Anonymisation").
                    However, if necessary, we may retain your personal
                    information for our compliance with a legal, accounting, or
                    reporting obligation or for archiving purposes in the public
                    interest, scientific, or historical research purposes or
                  ...
                  <LegalParagraph>
                    Data Protection and Privacy Laws permit us to collect and
                    use your personal data on a limited number of grounds.. In
                    which case, we will collect and use your personal
                    information lawfully, fairly and in a transparent manner. We
                    never directly market to any person(s) under 18 years of
                    age.
                  </LegalParagraph>
                  <LegalParagraph>
                    Our lawful bases depend on the services you use and how you
                    use them. This is a non-exhaustive list of the lawful bases
                    we use:
                  </LegalParagraph>
                  ...
                  <LegalParagraph>
                    ...
                    any time, we cannot recall any email we have already sent.
                    If you have any further enquiries about how to withdraw your
                  ...
                  <LegalParagraph>
                    ...
                    your personal information. Such cases may include (but are
                    not limited to) court orders, criminal investigations,
                    government requests, and regulatory obligations. For
                    example, we are required to keep financial records for a
                    period of 7 years. If you have any further enquiries about
                    how we retain personal information in order to comply with
                  ...
                  <LegalParagraph>
                    The personal information we collect is stored and/or
                    processed in the United Kingdom by us. Following an adequacy
                    decision by the EU Commission, the UK has been granted an
                    essentially equivalent level of protection to that
                    guaranteed under UK GDPR.
                  </LegalParagraph>
                  <LegalParagraph>
                    On some occasions, where we share your data with third
                    parties, they may be based outside of the UK, or the
                    European Economic Area ("EEA"). These countries to which we
                    store, process, or transfer your personal information may
                  ...
                  <ul className="mb-4 list-disc space-y-2 pl-6">
                    <li>
                      ...
                      requirements of the UK GDPR (Article 45) and Data
                      Protection Act 2018;
                    </li>
                    <li>
                  ...
                  <LegalParagraph>
                    ...
                    personal information has been unlawfully processed; (iii)
                    you need us to maintain the personal information solely for
                    the purpose of a legal claim; or (iv) we are in the process
                    of considering your objection in relation to processing on
                    the basis of legitimate interests.
                  </LegalParagraph>
                  <LegalParagraph>
                    <strong>Right to Object:</strong> You have the right to
                    object to processing of your personal information that is
                    based on our legitimate interests or public interest. If
                    this is done, we must provide compelling legitimate grounds
                    for the processing which overrides your interests, rights,
                    and freedoms, in order to proceed with the processing of
                  ...
                  <LegalParagraph>
                    ...
                    be informed with how your data is collected, processed,
                    shared and stored.
                  </LegalParagraph>
                  <LegalParagraph>
                    <strong>Right of Access:</strong> You may request a copy of
                    the personal information that we hold about you at any time
                    by submitting a Data Subject Access Request (DSAR). The
                    statutory deadline for fulfilling a DSAR request is 30
                    calendar days from our receipt of your request.
                  </LegalParagraph>
                  <LegalParagraph>
                  ...
                  <ul className="mb-4 list-disc space-y-2 pl-6">
                    ...
                    <li>
                      If consent was the lawful basis for processing personal
                      data and that consent has been withdrawn. Analog Interface
                      relies on consent to process personal data in very few
                      circumstances.
                    </li>
                    <li>
                    ...
                    <li>
                      There is legislation that requires that personal data are
                      to be destroyed.
                    </li>
                  </ul>
                  <LegalParagraph>
                    <strong>Right to Portability:</strong> Individuals have the
                    right to get some of their personal data from an
                    organisation in a way that is accessible and
                  ...
                  <LegalParagraph>
                    <strong>Notification of data breaches:</strong> Upon
                    discovery of a data breach, we will investigate the incident
                    and report it to the UK's data protection regulator and
                    yourself, if we deem it appropriate to do so.
                  </LegalParagraph>
                  <LegalParagraph>
                    <strong>Complaints:</strong> You have the right, at any
                    time, to lodge a complaint with the Information
                    Commissioner's Office (ICO), the UK supervisory authority
                    for data protection issues (
                    <LegalTextLink href="https://www.ico.org.uk">
                      www.ico.org.uk
                    </LegalTextLink>
                    ). We would, however, appreciate the chance to deal with
                    your concerns before you approach the ICO so please contact
                    us in the first instance using the details below. Please
                    provide us with as much information as you can about the
                  ...
                  <LegalParagraph>
                    ...
                    Protection Officer using the details in the Contact us
                    section of this privacy policy.
                  </LegalParagraph>
                  <LegalParagraph>
                    If we fail to resolve your concern to your satisfaction, you
                    may also contact the Information Commissioner's Office
