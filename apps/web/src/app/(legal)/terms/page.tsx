          ...
          <div className="mx-auto max-w-4xl">
            ...
            <Card className="border-2 border-muted/30 shadow-none">
              <CardContent className="space-y-8 p-8 text-base leading-relaxed">
                ...
                <LegalParagraph>
                  We, Analog Interface, reserve the right to review and amend
                  any of these Terms of Service at our sole discretion. Upon
                  doing so, we will update this page. Any changes to these Terms
                  of Service will take effect immediately from the date of
                  publication.
                </LegalParagraph>
                ...
                <section>
                  ...
                  <LegalParagraph>
                    ...
                    your users, and other parties you represent that you will
                    not:
                  </LegalParagraph>
                  <ul className="mb-4 list-disc space-y-2 pl-6">
                    ...
                    <li>
                      ...
                      any materials and software on this website;
                    </li>
                    <li>
                    ...
                    <li>
                      use this website or its associated services in violation
                ...
                <section>
                  ...
                  <LegalParagraph>
                    ...
                    protected by applicable copyright and trademark law. We
                    grant our users permission to download one copy of the
                  ...
                  <LegalParagraph>
                    ...
                    violate any of these restrictions or the Terms of Service,
                    and may be terminated by Analog Interface at any time.
                  </LegalParagraph>
                </section>
                ...
                <section>
                  ...
                  <LegalParagraph>
                    In no event shall Analog Interface or its suppliers be
                    liable for any consequential loss suffered or incurred by
                    you or any third party arising from the use or inability to
                    use this website or the materials on this website, even if
                    Analog Interface or an authorized representative has been
                ...
                <section>
                  ...
                  <LegalParagraph>
                    ...
                    the use of the materials on this website, or otherwise
                    relating to such materials or on any resources linked to
                    this website.
                  </LegalParagraph>
                </section>
                ...
                <section>
                  ...
                  <LegalParagraph>
                    ...
                    strongly advise you make your own investigations with
                ...
                <section>
                  ...
                  <LegalParagraph>
                    ...
                    and terminate these Terms of Service immediately upon
