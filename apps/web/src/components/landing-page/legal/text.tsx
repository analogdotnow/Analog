...
export function LegalHeading1({ children, className }: LegalHeadingProps) {
  return (
    <h1 className={cn("pb-4 text-4xl font-semibold md:text-6xl", className)}>
      {children}
    </h1>
  );
}
...
export function LegalHeading2({ children, className }: LegalHeadingProps) {
  return (
    <h2 className={cn("pb-4 text-2xl font-semibold", className)}>{children}</h2>
  );
}

export function LegalHeading3({ children, className }: LegalHeadingProps) {
  return (
    <h3 className={cn("pb-4 text-xl font-semibold", className)}>{children}</h3>
  );
}
