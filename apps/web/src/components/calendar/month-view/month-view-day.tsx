...
import { UseMultiDayOverflowResult } from "../hooks/use-multi-day-overflow";
...
interface MonthViewDayProps {
  ...
  dayIndex: number;
  overflow: ReturnType<
    typeof import("../hooks/use-multi-day-overflow").useMultiDayOverflow
  >;
...
function MonthViewCell({
  ...
  }, [day, createDraftAction, timeZone]);
