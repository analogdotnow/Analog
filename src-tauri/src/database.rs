...
#[command]
pub async fn get_calendars(_user_id: String, _app: AppHandle) -> Result<Vec<serde_json::Value>, String> {
    Ok(vec![])
}

#[command]
pub async fn save_calendar(_calendar_data: serde_json::Value, _app: AppHandle) -> Result<String, String> {
