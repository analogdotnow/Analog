...
export class ACL extends APIResource {
	 ...
	 */
	delete(ruleID: string, params: ACLDeleteParams, options?: RequestOptions): APIPromise<void> {
		const { calendarId, alt, fields, key, oauth_token, prettyPrint, quotaUser, userIp } = params;
...
export declare namespace ACL {
	export {
		ACLRule,
		type ACLRetrieveResponse,
		ACLCreateParams,
		type ACLRetrieveParams,
