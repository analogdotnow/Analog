...
export class CheckFreeBusy extends APIResource {
	...
	checkFreeBusy(
		...
		const { alt, fields, key, oauth_token, prettyPrint, quotaUser, userIp, ...body } = params ?? {};
...
export declare namespace CheckFreeBusy {
	export { CheckFreeBusyCheckFreeBusyResponse, type CheckFreeBusyCheckFreeBusyParams };
}
