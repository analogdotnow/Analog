...
export function loggerFor(client: GoogleCalendar): Logger {
...
export const formatRequestDetails = (details: {
	...
	if (details.options) {
		...
		details.options.headers = undefined; // redundant + leaks internals
	}
	if (details.headers) {
	...
	if ("retryOfRequestLogID" in details) {
		...
		details.retryOfRequestLogID = undefined;
	}
	return details;
};
