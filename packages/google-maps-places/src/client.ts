...
import {
  Circle,
  PlacesAutocomplete,
  PlacesAutocompletePredictParams,
  PlacesAutocompletePredictResponse,
  SuggestionFormatableText,
  SuggestionStructuredFormat,
} from "./resources/places-autocomplete";
import {
  PlacesSearchNearby,
  PlacesSearchNearbySearchParams,
  PlacesSearchNearbySearchResponse,
  RoutingParameters,
  RoutingSummary,
} from "./resources/places-search-nearby";
import {
  PlacesSearchText,
  PlacesSearchTextSearchParams,
  PlacesSearchTextSearchResponse,
} from "./resources/places-search-text";
import {
  AuthorAttribution,
  ContentBlock,
  LatLng,
...
export interface ClientOptions {
  /**
   * Defaults to process.env['GOOGLE_PLACES_API_KEY'].
   */
   ...
   *
   * Defaults to process.env['GOOGLE_PLACES_BASE_URL'].
   */
   ...
   * Set the log level.
   *
   * Defaults to process.env['GOOGLE_PLACES_LOG'] or 'warn' if it isn't set.
   */
...
/**
 * API Client for interfacing with the Google Places API.
 */
export class GooglePlaces {
   ...
   * API Client for interfacing with the Google Places API.
   *
   * @param {string | null | undefined} [opts.apiKey=process.env['GOOGLE_PLACES_API_KEY'] ?? null]
   * @param {string} [opts.baseURL=process.env['GOOGLE_PLACES_BASE_URL'] ?? https://places.googleapis.com] - Override the default base URL for the API.
   ...
   */
  constructor({
    baseURL = readEnv("GOOGLE_PLACES_BASE_URL"),
    apiKey = readEnv("GOOGLE_PLACES_API_KEY") ?? null,
    ...opts
  }: ClientOptions = {}) {
    ...
    this.timeout =
      options.timeout ?? GooglePlaces.DEFAULT_TIMEOUT /* 1 minute */;
    ...
    this.logLevel =
      ...
      parseLogLevel(
        readEnv("GOOGLE_PLACES_LOG"),
        "process.env['GOOGLE_PLACES_LOG']",
        this,
      ) ??
      defaultLogLevel;
  ...
  #baseURLOverridden(): boolean {
    return this.baseURL !== "https://places.googleapis.com";
  }
  ...
  protected stringifyQuery(query: Record<string, unknown>): string {
    return Object.entries(query)
      ...
      .map(([key, value]) => {
        ...
        throw new Errors.GooglePlacesError(
  ...
  static GooglePlaces = this;
  static DEFAULT_TIMEOUT = 60000; // 1 minute

  static GooglePlacesError = Errors.GooglePlacesError;
  ...
  places: API.Places = new API.Places(this);
  placesAutocomplete: API.PlacesAutocomplete = new API.PlacesAutocomplete(this);
  placesSearchNearby: API.PlacesSearchNearby = new API.PlacesSearchNearby(this);
  placesSearchText: API.PlacesSearchText = new API.PlacesSearchText(this);
}

GooglePlaces.Places = Places;
GooglePlaces.PlacesAutocomplete = PlacesAutocomplete;
GooglePlaces.PlacesSearchNearby = PlacesSearchNearby;
GooglePlaces.PlacesSearchText = PlacesSearchText;
...
export declare namespace GooglePlaces {
  ...
  export {
    PlacesAutocomplete as PlacesAutocomplete,
  ...
  export {
    PlacesSearchNearby as PlacesSearchNearby,
  ...
  export {
    PlacesSearchText as PlacesSearchText,
